...
class BankAccount:
    ...
    def withdraw(self, amount):
        ...
        to the transaction history, and return the new balance.
        """
        transaction_id, before = len(self.transactions), self.balance
        if amount > self.balance:
            after = self.balance
            self.transactions.append(Transaction(transaction_id, before, after))
            return 'Insufficient funds'
        self.balance, after = self.balance - amount, self.balance - amount
        self.transactions.append(Transaction(transaction_id, before, after))
        return self.balance
...
class Coin:
    ...
    def worth(self):
        "*** YOUR CODE HERE ***"
        coin_worth = self.cents
        if Mint.present_year - self.year > 50:
            coin_worth += Mint.present_year - self.year - 50
        return coin_worth
