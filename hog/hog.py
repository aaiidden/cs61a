...
def boar_brawl(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 2
    "*** YOUR CODE HERE ***"
    diff = abs(player_score % 10 - opponent_score % 100 // 10)
    if diff == 0:
        return 1
    else:
        return diff * 3
...
def always_roll(n):
    ...
    # BEGIN PROBLEM 6
    "*** YOUR CODE HERE ***"
    def strategy(cuurent_score, opponent_score):
        return n
    return strategy
    # END PROBLEM 6
...
def max_scoring_num_rolls(dice=six_sided, times_called=1000):
    ...
    # BEGIN PROBLEM 9
    "*** YOUR CODE HERE ***"
    max_score, best_roll_num, current_roll_num = 0, 1, 1
    while current_roll_num <= 10:
        roll_averaged_dice = make_averaged(roll_dice, times_called)
        current_score = roll_averaged_dice(current_roll_num, dice)
        if current_score > max_score:
            best_roll_num = current_roll_num
